...
export const stripeFees: Record<string, FeeStructure> = {
  ...
  ca: {
    ...
    internationalFixed: 0.30,
    lastUpdated: "2026-03-26",
    source: "Stripe Canada Pricing Page",
  },
  au: {
    platform: "Stripe",
    country: "Australia",
    ...
    internationalFixed: 0.30,
    lastUpdated: "2026-03-26",
    source: "Stripe Australia Pricing Page",
  },
};
...
export const paypalFees: Record<string, FeeStructure> = {
  ...
  ca: {
    ...
    domesticRate: 0.0289,
    domesticFixed: 0.30,
    internationalRate: 0.0389,
    internationalFixed: 0.30,
    lastUpdated: "2026-03-26",
    source: "PayPal Canada Business Fees",
  },
  au: {
    platform: "PayPal",
    country: "Australia",
    ...
    internationalFixed: 0.30,
    lastUpdated: "2026-03-26",
    source: "PayPal Australia Business Fees",
  },
};
